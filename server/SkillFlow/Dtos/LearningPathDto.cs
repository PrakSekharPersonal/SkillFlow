namespace SkillFlow.Dtos
{
    ...
    public record LearningPathDto(int Id, string Title, string? Description, DateTime CreatedAt);

    // This is what we receive from the React frontend.
    public record CreateLearningPathDto(string Title, string? Description);
}
